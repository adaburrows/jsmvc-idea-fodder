...
form_view.prototype.make = function() {
  ...
  this.view.append("<div id=\""+this.view_selector+"_nav\"><form><input type=\"button\" class=\"button\" id=\""+this.view_selector+"_cancel\" name=\""+this.view_selector+"_cancel\" value=\"Cancel\" /><input type=\"button\" class=\"button\" id=\""+this.view_selector+"_ok\" value=\"OK\" /></form></div>");
